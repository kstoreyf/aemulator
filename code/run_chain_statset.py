...
def main(cosmo, hod, mode, config_tag='', param_tag=''):
    ...
    overwrite_param_file = False
    #overwrite_param_file = True
    #print("OVERWRITE PARAM FILE TRUE, U SURE?")
    ...
    for stat_str in stat_strs:
        ...
        for config_tag in config_tags:
            ...
            chain_params_fn = initialize_chain.main(config_fn, overwrite_param_file=overwrite_param_file)
